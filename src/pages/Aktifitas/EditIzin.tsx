...
export default function EditIzin() {
  ...
  useEffect(()=>{
      if(data){
        const {izin_id, keterangan, tanggal_mulai, tanggal_selesai,telepon} = data.data
  ...
  },[data,setValue,payloadIzin])

  return (
    <>
      <IonPage>
        <KembaliHeader
          handleKembali={() => history.replace(`/aktifitas/${params.id}`)}
        />
        <IonContent scrollY>
          <form
            ...
            <div className="w-full px-12">
              ...
              <div className="flex flex-col justify-center items-center my-2 ">
                <div className="form_group">
                  <select
                    className="select select-bordered mt-2 select-sm rounded-xl w-full"
                    {...register("izin_id")}
                  >
                ...
                <div className="form_group">
                  ...
                  <input
                    type="date"
                    className="input input-bordered input-sm mt-2 rounded-xl w-full"
                ...
                <div className="form_group">
                  ...
                  <textarea
                    className="textarea textarea-bordered textarea-sm mt-2 rounded-xl w-full"
                    {...register("keterangan")}
                  />
